...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About GLYNO Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GLYNO Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the GLYNO Core help message to get a list with possible GLYNO Core command-line options"));
