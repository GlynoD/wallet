...
All the GLYNO in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GLYNO, 0.1 GLYNO, 1 GLYNO and 10 GLYNO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.glynocoin.org/PrivateSend\">https://www.glynocoin.org/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
