...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса GLYNO для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса GLYNO для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ GLYNO&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сейчас GLYNO Core закроется для завершения процесса шифрования. Помните, что шифрование вашего кошелька не может полностью защитить ваши даши от кражи с помощью инфицирования вашего компьютера вредоносным ПО.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа GLYNO Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес GLYNO</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и glyno: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменить параметры конфигурации GLYNO Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами GLYNO, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами GLYNO</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать справку по GLYNO Core со списком возможных параметров командной строки</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью GLYNO</numerusform><numerusform>%n активных соединения с сетью GLYNO</numerusform><numerusform>%n активных соединений с сетью GLYNO</numerusform><numerusform>%n активных соединений с сетью GLYNO</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Использовать 2 отдельные мастерноды для перемешивания до 1000 GLYNO</translation>
    </message>
    <message>
        <source>Use 8 separate masternodes to mix funds up to 1000 GLYNO</source>
        <translation>Использовать 8 отдельных мастернод для перемешивания до 1000 GLYNO</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Это самый быстрый вариант, анонимизация 1000 GLYNO будет стоить вам примерно 0.025 GLYNO</translation>
    </message>
    <message>
        <source>This option is moderately fast and will cost about 0.05 GLYNO to anonymize 1000 GLYNO</source>
        <translation>Это относительно быстрый вариант, анонимизация 1000 GLYNO будет стоить вам примерно 0.05 GLYNO</translation>
    </message>
    <message>
        <source>0.1 GLYNO per 1000 GLYNO you anonymize.</source>
        <translation>0.1 GLYNO за каждые анонимизированные 1000 GLYNO.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом GLYNO.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где GLYNO Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>GLYNO Core скачает и сохранит копию цепочки блоков. Как минимум %1ГБ данных будет храниться в этом каталоге и размер данных будет со временем расти. В этом же каталоге будет сохранён кошелёк.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью GLYNO, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Сумма постоянно анонимизированных GLYNO</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически запускать GLYNO Core после входа в систему.</translation>
    </message>
    <message>
        <source>&amp;Start GLYNO Core on system login</source>
        <translation>&amp;Запускать GLYNO Core при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для GLYNO Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети GLYNO через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска GLYNO Core.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети GLYNO через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью GLYNO после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 GLYNO / 0 раундов</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик glyno: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес GLYNO либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>GLYNO Core еще не завершил работу...</translation>
    </message>
    <message>
        <source>Amount</source>
        <translation>Сумма</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл GLYNO Core из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль GLYNO Core.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть GLYNO.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть GLYNO.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес GLYNO</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес GLYNO для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше GLYNO, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К glyno: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть GLYNO.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом GLYNO</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес GLYNO, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified GLYNO address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом GLYNO</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>InstantSend пока что не поддерживает такие большие суммы. На данный момент транзакции ограничены суммами до %1 GLYNO.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, GLYNO Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось привязаться к %s на этом компьютере. Возможно, GLYNO Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показывать N подтверждений для успешно заблокированной транзакции (0-7442, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: кошелёк требует более новой версии GLYNO Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверка на непротиворечивость закончилась неудачно. GLYNO Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать кошелёк: перезапустите GLYNO Core для завершения операции</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Держать N GLYNO анонимизированными (по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к GLYNO (Мастерноды, PrivateSend, InstantSend, Governance) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! GLYNO Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обнаружить достаточных для выполнения этой транзакции неденоминированных средств, отличающихся от 1000 GLYNO.</translation>
    </message>
    <message>
