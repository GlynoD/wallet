...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GLYNONetwork") type = GLYNONetwork;
    if(strType == "GLYNONetworkVariable") type = GLYNONetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GLYNONetwork) s = "GLYNONetwork";
    if(type == GLYNONetworkVariable) s = "GLYNONetworkVariable";
