 ...
 *
 *   // network
 *   CGLYNONetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.glyno.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGLYNONetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GLYNONetwork
// //   -- signature requirements : Key1(User)
// class CGLYNONetworkVariable : public CGovernanceObject
// {
// private:
