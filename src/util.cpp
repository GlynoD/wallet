...
const char * const BITCOIN_CONF_FILENAME = "glyno.conf";
const char * const BITCOIN_PID_FILENAME = "glynod.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GLYNO";
#else
    // Unix
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty glyno.conf if it does not excist
